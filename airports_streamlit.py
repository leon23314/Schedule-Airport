...
airports = pd.read_csv('C:/Users/ak230/schedule_airport.csv')
...
with open("C:/Users/ak230/airports.json") as f:
...
# Laad de luchthavengegevens van CSV
airports_cleaned = pd.read_csv('C:/Users/ak230/schedule_airport.csv')
...
df = pd.read_csv('C:/Users/ak230/schedule_airport.csv')
...
airport_data = pd.read_csv(r"C:\Users\ak230\Downloads\icao_codes.csv", delimiter=';')
...
airline_data = pd.read_excel(r"C:\Users\ak230\Downloads\airline_codes.xlsx")  # Update met je eigen bestandsnaam
...
df = pd.read_csv(r"C:\Users\ak230\schedule_airport.csv")
df.rename(columns={'Org/Des': 'ICAO'}, inplace=True)

df2 = pd.read_csv(r"C:\Users\ak230\airports-extended-clean (1).csv", delimiter=";")
...
path = "C:/Users/ak230/30Flight {}.xlsx"
...
with col2:
    ...
    <div style='background-color:white; padding:10px; border:1px solid grey;'>
        <h4>Legenda Altitude</h4>
        <div><span style='background-color: blue; display:inline-block; width: 20px; height: 10px;'></span> < 2000m</div>
        <div><span style='background-color: cyan; display:inline-block; width: 20px; height: 10px;'></span> 2000 - 5000m</div>
        <div><span style='background-color: green; display:inline-block; width: 20px; height: 10px;'></span> 5000 - 8000m</div>
        <div><span style='background-color: yellow; display:inline-block; width: 20px; height: 10px;'></span> 8000 - 11000m</div>
        <div><span style='background-color: orange; display:inline-block; width: 20px; height: 10px;'></span> 11000 - 14000m</div>
        <div><span style='background-color: red; display:inline-block; width: 20px; height: 10px;'></span> > 14000m</div>
    </div>
